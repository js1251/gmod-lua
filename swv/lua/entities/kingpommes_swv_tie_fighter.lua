...
ENT.EntModel = "models/KingPommes/starwars/tie/fighter.mdl"
ENT.Vehicle = "IMP_TIE_FIGHTER"
...
if SERVER then
	...
	function ENT:SpawnFunction(pl, tr)
		local e = ents.Create("kingpommes_swv_tie_fighter")
		e:SetPos(tr.HitPos + Vector(0,0,177))
	...
	function ENT:Initialize()
		...
		self.LandOffset = Vector(0,0, 177)
...
if CLIENT then
	...
	function IMP_TIEFighterOfDoomReticle()
		local p = LocalPlayer()
		local Flying = p:GetNWBool("FlyingIMP_TIE_FIGHTER")
		local self = p:GetNWEntity("IMP_TIE_FIGHTER")
		...
		if(Flying and IsValid(self)) then
			...
			SW_HUD_WingsIndicator("fighter",x,y)
		end
	end
	hook.Add("HUDPaint", "IMP_TIE_FIGHTERReticle", IMP_TIEFighterOfDoomReticle)
