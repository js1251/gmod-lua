...
util.PrecacheModel( "models/KingPommes/starwars/tie/interceptorR.mdl" )
if (!util.IsValidModel( "models/KingPommes/starwars/tie/interceptorR.mdl" )) then return end
...
if SERVER then
	...
	function ENT:SpawnFunction(pl, tr)
		local e = ents.Create("kingpommes_swv_tie_interceptor_r")
